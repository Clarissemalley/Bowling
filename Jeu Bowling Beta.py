...
def score():
    """Permet de marquer des points en fonctions des collisions des quilles"""
    X1, Y1, X2, Y2 = canvas.coords(boule)
    if len(canvas.find_overlapping(110,145,130,165))>1: # Détecte les collisions avec la quille
...
boule = canvas.create_oval(Pos_X,Pos_Y,Pos_X+50,Pos_Y+50, fill='black')
