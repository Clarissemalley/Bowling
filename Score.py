...
for colonne in range(2, 12):
    ...
    Label(fenetre, textvar=tr1, borderwidth=3).grid(row=2, column=2)
    Label(fenetre, textvar=tr2, borderwidth=3).grid(row=2, column=3)
    Label(fenetre, textvar=tr3, borderwidth=3).grid(row=2, column=4)
    Label(fenetre, textvar=tr4, borderwidth=3).grid(row=2, column=5)
    Label(fenetre, textvar=tr5, borderwidth=3).grid(row=2, column=6)
    Label(fenetre, textvar=tr6, borderwidth=3).grid(row=2, column=7)
    Label(fenetre, textvar=tr7, borderwidth=3).grid(row=2, column=8)
